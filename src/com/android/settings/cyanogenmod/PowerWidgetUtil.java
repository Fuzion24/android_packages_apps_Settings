...
public class PowerWidgetUtil {
    ...
    static {
        ...
        BUTTONS.put(BUTTON_OVERCHARGE, new PowerWidgetUtil.ButtonInfo(
                BUTTON_OVERCHARGE, R.string.title_toggle_fast_charge,
                "com.android.systemui:drawable/stat_over_charge_off"));
    }
